  ...
  <div class="offcanvas__body">
    <div class="offcanvas__left">
      <div class="offcanvas__logo">
        <a href="index.html"><img src="assets/imgs/logo.png" alt="Offcanvas Logo" class="logod"></a>
      </div>
  ...
  <div id="smooth-wrapper">
    <div id="smooth-content">
      <main>
        ...
        <img src="assets/imgs/bgpic.jpg" alt="" class="bgvbn bgvb3">
    ...
    <div class="waviy">
      ...
      <span style="--i:10">N</span>
        ...
        <section class="portfolio__area-6 mrlg">
              ...
              <div class="row">
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6">
                  <div class="sec-title-wrapper portfolio__title-wrap-6">
                    <div class="">
                      <h2 class="sec-sub-title animation__char_come grc">Featured</h2>
                      <h3 class="sec-title animation__char_come_long">Work</h3>
                      <p class="grc">We create stunning websites that captivate and elevate your online presence.
                      </p>
                    </div>
                    <div class="portfolio__pagination-6 grc">
                      <span class="portfolio__current grc">01</span> / 0<span class="portfolio__total"></span>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="portfolio__wrapper-6">
                    <div class="portfolio__list-6">
                      <div class="portfolio__item-6" data-portfitem="1">
                        <a href="#">
                          <img src="assets/imgs/ww1.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Website Design</h4>
                          </div>
                        </a>
                      </div>
                      ...
                      <div class="portfolio__item-6" data-portfitem="2">
                        <a href="#">
                          <img src="assets/imgs/ww2.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Website Design</h4>
                          </div>
                        </a>
                      ...
                      <div class="portfolio__item-6" data-portfitem="3">
                        <a href="#">
                          <img src="assets/imgs/ww3.png" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Website Design</h4>
                          </div>
                        </a>
                      ...
                      <div class="portfolio__item-6" data-portfitem="4">
                        <a href="#">
                          <img src="assets/imgs/ww4.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Website Design</h4>
                          </div>
                        </a>
                      ...
                      <div class="portfolio__item-6" data-portfitem="5">
                        <a href="#">
                          <img src="assets/imgs/ww5.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6">Website Design</h4>                            
                          </div>
                        </a>
                      </div>
                      ...
                      <div class="portfolio__item-6" data-portfitem="7">
                        <a href="#">
                          <img src="assets/imgs/ww6.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6">Website Design</h4>                            
                          </div>
                        </a>
        ...
        <!-- CTA area start -->
        <section class="cta__area ctabg">
          <div class="container line pb-110">
            <div class="line-3"></div>
            <div class="row">
              <div class="col-xxl-12">
                <div class="cta__content">
                  <p class="cta__sub-title mr2">Work with us</p>
