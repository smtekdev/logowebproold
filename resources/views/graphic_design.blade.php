  ...
  <div id="smooth-wrapper">
    <div id="smooth-content">
      <main>
        ...
        <img src="assets/imgs/bgpic.jpg" alt="" class="bgvbn bgvb2">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6">
                  <div class="sec-title-wrapper portfolio__title-wrap-6">
                    <div class="">
                      ...
                      <p class="grc">Explore our logo design service captivating visuals that bring your brand to life.
                      </p>
                    </div>
                  ...
                  <div class="portfolio__wrapper-6">
                    <div class="portfolio__list-6">
                      <div class="portfolio__item-6" data-portfitem="1">
                        <a href="#">
                          <img src="assets/imgs/crp.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Logo Design</h4>
                          </div>
                        </a>
                      </div>
                      ...
                      <div class="portfolio__item-6" data-portfitem="2">
                        <a href="#">
                          <img src="assets/imgs/lg2.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Logo Design</h4>
                          </div>
                        </a>
                      ...
                      <div class="portfolio__item-6" data-portfitem="3">
                        <a href="#">
                          <img src="assets/imgs/lg3.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Logo Design</h4>
                          </div>
                        </a>
                      ...
                      <div class="portfolio__item-6" data-portfitem="4">
                        <a href="#">
                          <img src="assets/imgs/lg44.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6 grc">Logo Design</h4>
                          </div>
                        </a>
                      ...
                      <div class="portfolio__item-6" data-portfitem="5">
                        <a href="#">
                          <img src="assets/imgs/lg5.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6">Logo Design</h4>                            
                          </div>
                        </a>
                      </div>
                      ...
                      <div class="portfolio__item-6" data-portfitem="7">
                        <a href="#">
                          <img src="assets/imgs/log4.jpg" alt="Portfolio Image" data-speed="0.4">
                          <div class="portfolio__content-6">
                            <h4 class="portfolio__title-6">Logo Design</h4>                            
                          </div>
                        </a>
